...
if __name__ == '__main__':
	...
	with detection_graph.as_default():
		...
		with tf.io.gfile.GFile(PATH_TO_CKPT, 'rb') as fid:
			...
			# Now you can create a TensorRT inference graph from your frozen graph(od_graph_def)
			converter = trt.TrtGraphConverter(
				input_graph_def=od_graph_def, 
				nodes_blacklist=['image_tensor', 'detection_boxes', 'detection_scores', 'detection_classes', 'num_detections'])
